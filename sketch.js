...
function preload(){
  ...
  clickSound = loadSound("images/checkPoint.mp3");
  bookImg = loadImage("images/cash.png")
}
...
shirt = createSprite(450, 450);
 ...
 mouse = createSprite(470, 350);
 mouse.addImage("Mouse", mouseImage);
 mouse.scale =0.3;
 mouse.visible=false;

 food = createSprite(260, 350);
...
if(keyDown(DOWN_ARROW)){
  ...
  console.log(livingr.depth);
  console.log(OMG.depth);
 console.log(fry.depth);
 console.log(banana.x);
 console.log(plate.depth);
 //console.log(cup.depth);
console.log(scene2.depth);
}
...
function live()
{
 ...
 if(banana.x ===400 && World.seconds>10){
